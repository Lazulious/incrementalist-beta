...
function updateIncrementP(n) {
  if (d("incrementP" + n).style.display != "none") {
    ...
    if (user.ip.x.lt(cost) || cost == "Infinite") {rpc("canBuy", "cantBuy", "incrementP" + n + "b")}
...
function updateIncrementM(n) {
  if (d("incrementM" + n).style.display != "none") {
    ...
    if (user.ip.x.lt(cost) || cost == "Infinite") {rpc("canBuy", "cantBuy", "incrementM" + n + "b")}
...
function updateIncrementE(n) {
  if (d("incrementE" + n).style.display != "none") {
    ...
    if (user.ip.x.lt(cost) || cost == "Infinite") {rpc("canBuy", "cantBuy", "incrementE" + n + "b")}
