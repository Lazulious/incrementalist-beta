...
function unlockautomate(layer) {
  if (layer == "ip") {
    ...
    if (user.automation.scale.inc.p) {s("automationscaleincp"); s("automatescaleincp")} else {h("automatescaleincp")}
    if (user.automation.scale.inc.m) {s("automationscaleincm"); s("automatescaleincm")} else {h("automatescaleincm")}
